...
export class TrainSectionDtoMapper {
    ...
    static mapSameSectionsToSectionSummaryDto(sameSections: ({
        plannedDeparture: Date | null,
        actualDeparture: Date | null;
        stationFrom: TrainStation,
        stationTo: TrainStation;
    ...
    static caluclateDeparturesDelayMinutes(section: { plannedDeparture: Date | null, actualDeparture: Date | null; }) {
    ...
    static calculateArrivalDelayMinutes(section: { plannedArrival: Date | null, actualArrival: Date | null; }) {
